...
from shared.data_layout import camp_links_csv, quality_tier_csv
from phase_a.discover import ConfigError, search
from shared.llm import OllamaError, chat, is_available
from phase_b.session_quality import split_sessions
...
def run_gap_fill(
    ...
    *,
    ...
    from phase_b.parent_verify import load_sessions_for_verify
