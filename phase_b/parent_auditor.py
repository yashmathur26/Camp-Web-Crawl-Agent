...
from phase_b.session_quality import split_parent_verdicts
...
def _rule_based_holes(
    ...
    from phase_a.demand_ranker import rank_holes
...
def audit_catalog(
    ...
    *,
    ...
    from phase_c.categorizer import categorize_sessions
