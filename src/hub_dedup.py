...
from src.urls import normalize_url, register_platform_id
...
def stable_platform_id(url: str, *, course_no: str = "") -> str:
    ...
    Builds on src.urls.register_platform_id (WebTrac FMID / MyRec ProgramID) and
    ...
    from src.urls import canonical_register_url
