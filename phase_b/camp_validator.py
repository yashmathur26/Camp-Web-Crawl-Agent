...
from phase_b import harvest_log
from shared.llm import OllamaError, chat, chat_with_repair, is_available
from phase_b.registration import is_camp_catalog_url, is_registration_platform_url
...
async def filter_rows_with_llm(
    ...
    *,
    ...
    from shared.llm_pool import get_metrics, reset_metrics, run_batch
