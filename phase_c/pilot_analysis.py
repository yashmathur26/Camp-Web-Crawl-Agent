...
from phase_a.link_quality import drop_reason
from shared.store import count_camp_links
...
def update_pilot_analysis(
    ...
    *,
    ...
    from shared.data_layout import LOGS_ROOT, town_log_dir
    ...
    lines = [
        ...
        f"> **Command:** `./venv/bin/python -m orchestrator.run --no-dry-run --phase all --town {town}`  ",
        "",
        "---",
        "",
        "## Executive summary",
