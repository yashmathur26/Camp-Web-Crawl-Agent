...
from phase_b.hub_safeguards import (
    apply_host_bounds,
    diff_snapshot,
    register_url_gate,
    write_snapshot,
...
from phase_d.hubs import camp_invention as _camp_invention
from phase_d.hubs import configio as _configio
from phase_d.hubs import idtech as _idtech
...
async def run_hub(
    ...
    *,
    ...
    from phase_a.geo_resolve import keep_if_ma
