...
from phase_c.gap_finder import run_gap_fill as taxonomy_gap_fill
from phase_b.parent_auditor import audit_catalog
from phase_b.parent_verify import load_sessions_for_verify, run_parent_verify
from phase_b.session_quality import write_quality_csvs
from phase_b.sessions import enumerate_town, host_of, write_session_outputs
from shared.store import save_new_links
...
def _seed_urls_for_hosts(hosts: set[str], town: str) -> list[str]:
    from phase_b.sessions import load_provider_urls
...
def _enumerate_new_hosts_engine(
    ...
    from phase_c.engine_bridge import enumerate_hosts_via_engine
...
def run_agentic_gap(
    ...
    *,
    ...
    from phase_b.resource_guard import gate, log_memory
    ...
    for round_num in range(1, rounds + 1):
        ...
        from phase_c.provider_registry import skippable_holes
        ...
        if new_hosts and gap_urls:
            ...
            from phase_c.provider_registry import register_sessions
    ...
    from phase_c.coverage_matrix import build_matrix, coverage_summary, write_matrix
    from phase_c.provider_registry import register_sessions, registry_coverage
